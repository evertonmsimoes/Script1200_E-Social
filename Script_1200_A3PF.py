...
def realizar_login(navegador):
    ...
    sleep(0.7)
    pyautogui.hotkey('enter')
    clicar_elemento("/html/body/div[3]/div[4]/div/form/div/section/div[1]/div/select")
    sleep(0.7)
    ...
    sleep(0.7)
    pyautogui.hotkey('enter')
    preencher_campo("/html/body/div[3]/div[4]/div/form/div/section/div[3]/div[1]/input", cnpj)
    sleep(0.8)
    clicar_elemento("/html/body/div[3]/div[4]/div/form/div/section/div[3]/div[2]/input")
    clicar_elemento("/html/body/div[3]/div[4]/div/form/div/section/div[7]/div[2]/div[4]/div")


# Função para Realizar Relogin no sistema do E-Social.        
def  realizar_relogin():
